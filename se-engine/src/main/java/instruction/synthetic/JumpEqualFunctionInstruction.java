...
public class JumpEqualFunctionInstruction extends AbstractInstruction
    ...
    /**
     * Inlining:
     *   L? : t == (f(args)) ? goto J : fallthrough
     * becomes:
     *   [carry original label] tmp <- (f(args))
     *   JEV t, tmp, J
     */
    @Override
...
//    private final List<QuoteArg> quoteArguments =  new ArrayList<>();
//    private final Label referenceLabel;
//
//    private int currentCyclesNumber;
//    private final List<Instruction> innerInstructions = new ArrayList<>();
//
//    public JumpEqualFunctionInstruction(Variable targetVariable, Label label, Label referenceLabel, Instruction origin, int instructionNumber, String referenceFunctionName, List<QuoteArg> quoteArguments) {
//        super(InstructionData.JUMP_EQUAL_FUNCTION, InstructionType.SYNTHETIC, targetVariable, label, origin, instructionNumber);
...
//    @Override
//    public Instruction createInstructionWithInstructionNumber(int instructionNumber) {
//        return new JumpEqualFunctionInstruction(getTargetVariable(), getLabel(), referenceLabel, getOriginalInstruction(), instructionNumber, this.referenceFunctionName, this.quoteArguments);
//    }
//
//    @Override
//    public Label execute(ExecutionContext context) {
...
//
//        Instruction clonedInstruction = new JumpEqualFunctionInstruction(tgtLbl, newLbl, referenceLabel, origin, newInstructionNumber, referenceFunctionName, quoteArguments);
